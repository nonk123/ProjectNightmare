/// @description draw_image_tiled_area_ext(image,subimg,x1,y1,x2,y2,xscale,yscale,colour,alpha)
/// @param image
/// @param subimg
/// @param x1
/// @param y1
...
/// @param colour
/// @param alpha
function draw_image_tiled_area_ext(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
