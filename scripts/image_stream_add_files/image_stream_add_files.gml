/// @description image_stream_add_files(group,identifier,basename,xorig,yorig) - creates a sprite from a list of files with the specified name (spr_player_0,spr_player_1,...etc)
/// @param group
/// @param identifier
/// @param basename
/// @param xorig
/// @param yorig
function image_stream_add_files(argument0, argument1, argument2, argument3, argument4) {
