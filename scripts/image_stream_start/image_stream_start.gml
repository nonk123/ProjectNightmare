/// @description image_stream_start(group, tex_page_width, tex_page_height, tex_sep, clamp, removeback)
/// @param group
...
/// @param  clamp
/// @param  removeback
function image_stream_start(argument0, argument1, argument2, argument3, argument4, argument5) {
	/*
	    returns boolean;
	*/
