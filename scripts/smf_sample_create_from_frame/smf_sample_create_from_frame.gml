/// @description  @description smf_sample_create_from_frame(frame)
/// @param frame
/// @param frame
function smf_sample_create_from_frame(argument0) {
	/*

	Script made by TheSnidr
	www.TheSnidr.com
	*/
	var frame, time, type, animationIndex, loop, quadratic, linear, bindPose, frameGrid, worldDQ, Qa, Qb, Qc, deltaWorldDQ, boneNum, frameNum, pDQ, cDQ, dWDQ, lr, ld, a, b, i, j, l, p, f, ma, mb, d, Q, bindDQ, localFrame, framePriority, returnSample;
	frame = argument0;
