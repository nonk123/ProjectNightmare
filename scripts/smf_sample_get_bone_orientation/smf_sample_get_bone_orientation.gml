/// @description  @description smf_sample_get_bone_orientation(sample, boneIndex)
/// @param sample
/// @param  boneIndex
/// @param sample
/// @param boneIndex
function smf_sample_get_bone_orientation(argument0, argument1) {
	...
	*/
	var bindPose, bone, sample, R, S, Q, i;
	sample = argument0;
	bone = argument1;
	bindPose = SMF_bindList[| sample[array_length_1d(sample) - 1]];
	S = bindPose[| bone];
	i = 8;
